  ...
  describe "when the git-status:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        gitStatusElement = workspaceElement.querySelector('.git-status')
        expect(gitStatusElement).toExist()

        gitStatusPanel = atom.workspace.panelForItem(gitStatusElement)
        expect(gitStatusPanel.isVisible()).toBe true
        atom.commands.dispatch workspaceElement, 'git-status:toggle'
        expect(gitStatusPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        gitStatusElement = workspaceElement.querySelector('.git-status')
        expect(gitStatusElement).toBeVisible()
        atom.commands.dispatch workspaceElement, 'git-status:toggle'
        expect(gitStatusElement).not.toBeVisible()
